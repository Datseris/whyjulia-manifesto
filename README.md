...
6. **Julia is written in Julia** ([from a practical academic's point of view](https://discourse.julialang.org/t/how-is-julia-written-in-julia/50918/8?u=datseris)). This is part of the reason why Julia solves the two language problem, and it comes with even more advantages.
...
8. **Developer communities around seemingly every area of science.** Going beyond the above mentioned developer communities, Julia also appears to have _a developer community_ around seemingly every area of science. For example
